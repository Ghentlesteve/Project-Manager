export default class Project {
  ...
  static updateTask(taskId, updatedInfo) {
    ...
    const targetColumn = data.find(column => {
      return column.columnId == updatedInfo.columnId;
    });
...
// console.log(Project.getTasks(1));

// Project.insertTask(0, "Building Project at Asokoro");

// Project.deleteTask(42197);
// console.log(Project.getTasks());

// console.log(Project.getAllTasks());

// Project.updateTask(97522, {
//     columnId: 2,
//     content: "First drag and drop concept"
// });
